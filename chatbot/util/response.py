...
NO_TOILET_PROBLEM = {"answer" : "문제가 없으세요.","dialog_type" : 0}
...
OFFER_MEAL_WHEN_NOT_MOVED = {"answer" : "주방에 움직임이 감지되지 않았어요. 혹시 식사를 챙겨드시지 않으셨다면 꼭 챙겨드시길 바랄게요. 건강을 지키는 것이 가장 중요해요", "dialog_type" : 0}
OFFER_MEAL_WHEN_MOVED = {"answer" : "외출 기록이 있으시네요. 외식을 하셨나봐요. 혹시 그것이 아니라면 꼭 식사를 챙겨드시길 바랄게요. 건강을 지키는 것이 가장 중요해요",  "dialog_type" : 0}
NORMAL_STATUS = {"answer" : "잘하셨어요! 식사를 잘 챙겨드시는게 가장 중요해요", "dialog_type" : 0}


# 건강
TOO_FEW_VISITS_TOILET = {"answer" : "화장실 가신 횟수가 매우 작아요. 혹시 변비 증상이 있으신가요?", "dialog_type" : 1}
TOO_MUCH_VISITS_TOILET =  {"answer" : "화장실을 자주 가신 것을 확인돼요. 혹시 몸이 아프신가요?", "dialog_type" : 2}
